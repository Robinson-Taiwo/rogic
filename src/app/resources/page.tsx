    ...
    return (
        <div className="w-full  items-center flex-col justify-center pt-28  flex "  >
            ...
            <div className="max-w-5xl flex items-center justify-center flex-col ">
                ...
                <div className="w-full  text-sm items-center mb-6 justify-center flex">Framer templates and design tools
                </div>
                ...
                <div className='w-full justify-center px-8  lg:px-0 items-center flex flex-col ' >
